...
SELECT
    (SELECT COUNT(*) FROM reggie_pierce_7405614800873570.pizza_vision.bronze_frames_raw)     AS raw_frames,
    (SELECT COUNT(*) FROM reggie_pierce_7405614800873570.pizza_vision.silver_frames_deduped) AS deduped_frames,
    (SELECT COUNT(*) FROM reggie_pierce_7405614800873570.pizza_vision.pipeline_frames)       AS processed_frames,
    (
